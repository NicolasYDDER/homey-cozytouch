...
3. [Adding Your First Device](#adding-your-first-device)
4. [Understanding Device Types](#understanding-device-types)
5. [Controlling Your Devices](#controlling-your-devices)
6. [Device Settings](#device-settings)
7. [Creating Automations (Flows)](#creating-automations-flows)
8. [Managing Devices](#managing-devices)
...
If you change your Cozytouch account password, you need to:
1. Remove all your Cozytouch devices from Homey
2. Re-add them using the new password
...
Yes! Thermor and Sauter are brands owned by Groupe Atlantic and use the same Cozytouch platform. If your device works with the Cozytouch app, it should work with this Homey app.

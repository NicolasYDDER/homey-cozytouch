...
// ── Shogun Zone Control (Overkiz Pass APC protocol names) ────────

const ZONE_CONTROL_OPERATING_TO_HVAC = {
  heating: 'heat',
  cooling: 'cool',
  drying: 'dry',
  stop: 'off',
...
const HVAC_TO_ZONE_CONTROL_OPERATING = {
  heat: 'heating',
  cool: 'cooling',
  dry: 'drying',
  off: 'stop',
...
const ZONE_CONTROL_ZONE_MODE_TO_OVERKIZ = {
  off: 'stop',
  manual: 'manu',
  prog: 'internalScheduling',
};

const ZONE_CONTROL_OVERKIZ_TO_ZONE_MODE = {
  stop: 'off',
  manu: 'manual',

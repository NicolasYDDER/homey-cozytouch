...
// Fil pilote interfaces (AtlanticElectricalHeaterIOComponent) — setHeatingLevel only
const FIL_PILOTE_LEVEL_TO_MODE = {
  off: 'off',
  comfort: 'manual',
  'comfort-1': 'manual',
  'comfort-2': 'manual',
...
const MODE_TO_FIL_PILOTE_LEVEL = {
  off: 'off',
  manual: 'comfort',
  eco_plus: 'eco',
};
...
module.exports = {
  ...
  FIL_PILOTE_LEVEL_TO_MODE,
  MODE_TO_FIL_PILOTE_LEVEL,
  OVERKIZ_DHW_TO_MODE,
  MODE_TO_OVERKIZ_DHW,
  getStateValue,
};

...
// ── Pass APC protocol (io:PassAPC*) ──────────────────────────────
//
// Shared by the Shogun Zone Control and by the Alféa / Excellia heat pumps: the
// operating modes, zone modes, states and commands below are the protocol, not a
// Shogun specificity. The ZONE_CONTROL_* names are kept as aliases because the
// zone_control driver was written before the heat pumps were supported.
...
const PASS_APC_HVAC_TO_OPERATING = {
  heat: 'heating',
  cool: 'cooling',
  dry: 'drying',
  off: 'stop',
...
const PASS_APC_STATES = {
  ...
  // Heat pump circuits report their setpoint under one of these instead of
  // core:HeatingTargetTemperatureState, depending on the product.
  DEROGATED_TARGET_TEMP: 'core:DerogatedTargetTemperatureState',
  COMFORT_HEATING_TARGET_TEMP: 'core:ComfortHeatingTargetTemperatureState',
  ECO_HEATING_TARGET_TEMP: 'core:EcoHeatingTargetTemperatureState',
};
...
// Historical names, still used by drivers/zone_control.
const ZONE_CONTROL_OPERATING_TO_HVAC = PASS_APC_OPERATING_TO_HVAC;
const HVAC_TO_ZONE_CONTROL_OPERATING = PASS_APC_HVAC_TO_OPERATING;
const ZONE_CONTROL_ZONE_MODE_TO_OVERKIZ = PASS_APC_ZONE_MODE_TO_OVERKIZ;
const ZONE_CONTROL_OVERKIZ_TO_ZONE_MODE = PASS_APC_OVERKIZ_TO_ZONE_MODE;
const ZONE_CONTROL_STATES = PASS_APC_STATES;
const ZONE_CONTROL_COMMANDS = PASS_APC_COMMANDS;
